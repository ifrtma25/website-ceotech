...
@section('title', 'Demisioner 2020-2021')
@section('content')
    @if (session('status'))
        <script>
            Swal.fire({
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Demisioner 2020-2021</h4>
                        <a class="btn btn-danger" href="{{ route('demisioner_admin') }}">Semua Periode</a>
                        <a class="btn btn-danger {{ Request::is('demisioner_2020-2021') ? 'active' : '' }}"
                            href="{{ route('2020-2021') }}">Periode 2020-2021</a>
