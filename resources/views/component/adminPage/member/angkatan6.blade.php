...
@section('title', 'Member Angkatan VI')
@section('content')
    @if (session('status'))
        <script>
            Swal.fire({
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Member Angkatan VI</h4>
                        <div class="card-body">
                            <a class="btn btn-danger" href="{{ route('member.admin') }}">Semua Angkatan</a>
                            <a class="btn btn-danger {{ Request::is('member_angkatan6') ? 'active' : '' }}"
                                href="{{ route('angkatan6') }}">Angkatan VI</a>
